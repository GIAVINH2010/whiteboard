...
let TextBox = (function () {
  function TextBox(canvas, params) {
    this.canvas = canvas;
  ...
  TextBox.prototype.bindEvents = function (params) {
    let inst = this;
    inst.canvas.on("mouse:down", function (o) {
      inst.onMouseDown(o, params);
    });
    // inst.canvas.on("mouse:move", function (o) {
    //   inst.onMouseMove(o);
    // });
  ...
  TextBox.prototype.onMouseDown = function (o, params) {
    console.log(
      "🚀 ~ file: shapes.fabric.js ~ line 213 ~ TextBox ~ params",
      params
    );
    let inst = this;
    ...
    let textbox = new fabric.IText("Your text here....", {
      left: origX,
      top: origY,
      width: 150,
      ...(params
  ...
  TextBox.prototype.onMouseUp = function (o) {
    canvas.off("mouse:down");
    canvas.off("mouse:move");
    canvas.off("mouse:up");
  };

  TextBox.prototype.isEnable = function () {
    return this.isDrawing;
  };
...
let Rectangle = (function () {
  ...
  Rectangle.prototype.removeEvents = function () {
    let inst = this;
    inst.canvas.off("mouse:down");
    inst.canvas.off("mouse:move");
    inst.canvas.off("mouse:up");
    inst.canvas.forEachObject(function (obj) {
  ...
  // Rectangle.prototype.setParam = function (param, value) {
  //   let inst = this;
  //   const activeObj = inst.canvas.getActiveObject();
  //   const type = activeObj.get("type");
  //   console.log(
  //     "🚀 ~ file: shapes.fabric.js ~ line 336 ~ Rectangle ~ type",
  //     type
  //   );

  //   if (activeObj) {
  //     activeObj.set(param, value);
  //     inst.canvas.renderAll();
  //   }
  // };
